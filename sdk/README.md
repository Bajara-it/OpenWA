...
> **Not yet published** to npm / PyPI / Packagist. The package names below are
> reserved for the first release; until then, install from a checkout of this
> repo (see each language section). Note: an unrelated third-party `openwa-sdk`
> exists on PyPI — it is **not** this project; do not install it.
